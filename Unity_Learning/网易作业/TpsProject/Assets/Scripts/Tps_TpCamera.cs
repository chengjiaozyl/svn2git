...
public class Tps_TpCamera : MonoBehaviour
{
    //初始版本第三人称相机
    ...
    public Vector3 positionOffset = new Vector3(0, 1, -5f);
    ...
    {
        Quaternion xQuaterion = Quaternion.AngleAxis(y_Angle, Vector3.up);
        Quaternion yQuaterion = Quaternion.AngleAxis(0, Vector3.left);
        m_Transform.parent.rotation = xQuaterion * yQuaterion;

        yQuaterion = Quaternion.AngleAxis(-x_Angle, Vector3.left);
        m_Transform.rotation = xQuaterion * yQuaterion;
    }
